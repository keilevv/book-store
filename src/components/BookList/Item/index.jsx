...
function BookListItem({ book, index, loading, addToReadingList }) {
  ...
  return (
    ...
    >
      ...
      <div
        id={`book-${book.ISBN}`}
        className="absolute inset-0 flex flex-col justify-center items-center text-center text-white bg-black bg-opacity-80 opacity-0 hover:opacity-100 transition-opacity duration-300"
      >
